...
from services import KafkaClient, Topics, MinioClient, BucketName
import uuid
...
class StoreCodeAPIView(GenericAPIView):
    ...
    def post(self, request):
        ...
        successful_upload_to_minio = MinioClient.upload(code_id, file, BucketName.Code.value, postfix='')
